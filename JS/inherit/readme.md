...
3. 继承三步
  - 父类的构造函数执行一下 Parent.call(this,args)，args为父类构造函数的参数，相当于super()
  - prototype属性指向 父类的实例。 - 用于继承父类上的属性（除构造时外的）和方法
...
- typeof 其实复杂数据类型只有function 和object 是语法原生支持的，其它的都只是变种而已。
Function VS Object
一等对象，js 才是真正的面向对象
函数：可以被执行的对象
可以当做Object的构造函数。
